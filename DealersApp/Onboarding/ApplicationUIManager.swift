...
class ApplicationUIManager: ApplicationUIManaging {
    ...
    func hideApplicationScreen(scene _: String?, completionHandler: @escaping (Error?) -> Void) {
    ...
    func showApplicationScreen(scene _: String?, completionHandler: @escaping (Error?) -> Void) {
